      ...
      <section  style="padding: 40px 0" >
        <div class="container " >
            <div class="row">
                ...
                <div class="col-md-4"></div>
                <div class="col-md-4">
                  <form action="<?php echo e(route('books.search')); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mukalama/public_html/mukalma/resources/views/book-category.blade.php ENDPATH**/ ?>