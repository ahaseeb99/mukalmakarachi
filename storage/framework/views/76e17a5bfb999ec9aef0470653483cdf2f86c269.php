        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
          <div class="d-flex align-items-center flex-wrap mr-2">
            <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
              ...
              <li class="breadcrumb-item active"><a href="<?php echo e(route('admin.books.index')); ?>" class="text-muted">Books</a></li>
            </ul>
          </div>
        ...
        <div class=" main-container d-flex flex-column-fluid">
          <div class="container">
            <div class="card card-custom">
                ...
                <div class="card-title"><h3 class="card-label">Books</h3></div>
                ...
                <table class=" table table-hover table-checkable" id="my_datatable" style="margin-top: 13px !important">
                  <thead>
                      <tr>
                        ...
                        <th style="font-size: 16px;" class="text-center" > Thumbnail</th>
                        <th style="font-size: 16px;" class="text-center" > Title</th>
                        <th style="font-size: 16px;" class="text-center" > Price</th>
                        <th style="font-size: 16px;" class="text-center" > PDF</th>
                        <th style="font-size: 16px;" class="text-center" > Category</th>
                        <th style="font-size: 16px;" class="text-center" > Author</th>
                  ...
                  <tbody>
                    <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>             
                        <tr class="odd gradeX">
                              ...
                              <td class="2 text-center" ><img width="50px" src="<?php echo e(asset($item->thumbnail)); ?>" /></td>
                              <td class="urdu 3 text-left"> <?php echo e($item->title); ?></td>
                              <td class="6 text-left"><?php echo e(number_format($item->price,2)); ?> Rs</td>
                              <td class="6 text-left">$ <?php echo e(number_format($item->pdf_price,2)); ?></td>
                              <td class="12 text-center"><?php echo e($item->category->title); ?></td>
                              <td class="9 text-center"><?php echo e($item->author->title); ?></td>
                              <td class="16 text-center">
                                <a href="<?php echo e(route('admin.books.edit', $item->id)); ?>" class="btn btn-sm btn-clean btn-icon" title="Edit">
                                      ...
                                      <div class="modal-dialog modal-dialog-centered " role="document">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-footer">
                                            ...
                                            <a href="<?php echo e(route('admin.books.delete', $item->id)); ?>"  class="btn btn-primary">Delete</a>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mukalama/public_html/resources/views/admin/books/index.blade.php ENDPATH**/ ?>