          ...
          <div class="container">
            <div class="card card-custom">
              <div class="card-header flex-wrap py-5">
                    <div class="card-title"><h3 class="card-label">Magzines</h3></div>
                  ...
                  <tbody>
                    <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>             
                        <tr class="odd gradeX">
                              ...
                              <td class="3 urdu text-left"> <?php echo e($item->title); ?></td>
                              ...
                              <td class="16 text-center">
                                <a href="<?php echo e(route('admin.magazines.edit', $item->id)); ?>" class="btn btn-sm btn-clean btn-icon" title="Edit">
                                      ...
                                      <div class="modal-dialog modal-dialog-centered " role="document">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-footer">
                                            ...
                                            <a href="<?php echo e(route('admin.magazines.delete', $item->id)); ?>"  class="btn btn-primary">Delete</a>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mukalama/public_html/resources/views/admin/magazines/index.blade.php ENDPATH**/ ?>