              ...
              <div class="card-body">
                ...
                <table class="table table-hover table-checkable" id="my_datatable" style="margin-top: 13px !important">
                  ...
                  <tbody>
                    ...
                    <?php $__currentLoopData = $newslater; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      ...
                                      <div class="modal-dialog modal-dialog-centered " role="document">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-footer">
                                            ...
                                            <a href="<?php echo e(route('admin.news.delete', $item->id)); ?>"  class="btn btn-primary">Delete</a>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
                                <!--<a href="<?php echo e(route('admin.news.delete',$item->id)); ?>" class=" delete_btn btn btn-sm btn-clean btn-icon" title="Delete"><i class="text-danger la la-trash"></i></a>-->
                              </td>
                        </tr>
...
<script src="<?php echo e(asset('admin/assets/js/pages/crud/datatables/search-options/advanced-search9cd7.js?v=7.1.5')); ?>"></script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mukalama/public_html/resources/views/admin/news_later.blade.php ENDPATH**/ ?>