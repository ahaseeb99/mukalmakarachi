      ...
      <div class="d-flex align-items-center flex-wrap mr-2">
        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
          ...
          <li class="breadcrumb-item active">
             <a href="<?php echo e(route('admin.users.index')); ?>" class="text-muted">Users</a>
          </li>
        </ul>
      </div>
              ...
              <div class="card-body">
                ...
                <table class="table table-hover table-checkable" id="my_datatable" style="margin-top: 13px !important">
                  <thead>
                      <tr>
                        <th> #</th>
                        <th style="font-size: 16px;" class="text-left" > Name</th>
                        <th style="font-size: 16px;" class="text-left" > Email</th>
                        <th style="font-size: 16px;" class="text-left" > Phone</th>
                        <th style="font-size: 16px;" class="text-left" > Joined Date</th>
                  ...
                  <tbody>
                    ...
                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr class="odd ">
                              ...
                              <td class="text-left" > <?php echo e($item->mobile); ?> </td>
                              <td class="text-left" > <?php echo e($item->created_at->format('d-m-Y')); ?> </td>
                                      ...
                                      <div class="modal-dialog modal-dialog-centered " role="document">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-footer">
                                            ...
                                            <a href="<?php echo e(route('admin.users.delete', $item->id)); ?>"  class="btn btn-primary">Delete</a>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
    ...
    $(document).ready(function(){
      ...
      var table = $('#my_datatable').DataTable({
        ...
        searchPlaceholder: "Search"
         ...
         ordering: false,
        responsive: false,
        dom: `<'row' <"col-md-6"  > <"col-md-6 text-right " f> <'col-sm-12'tr >><'row'<'col-sm-12 col-md-5'><'col-sm-12 col-md-7 dataTables_pager'lp>>`,
      });
...
<?php echo $__env->make('admin.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mukalama/public_html/resources/views/admin/users/index.blade.php ENDPATH**/ ?>