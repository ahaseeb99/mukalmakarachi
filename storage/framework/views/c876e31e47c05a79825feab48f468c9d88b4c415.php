      ...
      <div class="d-flex align-items-center flex-wrap mr-2">
        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
          ...
          <li class="breadcrumb-item active">
             <a href="<?php echo e(route('admin.categories.index')); ?>" class="text-muted">Book Categories</a>
          </li>
        </ul>
      </div>
      <div class="d-flex align-items-center">
            <a href="<?php echo e(route('admin.categories.create')); ?>" class="update_btn btn btn-primary"> Add New </a>
          </div>
        </div>
      </div>
      ...
      <div class=" main-container d-flex flex-column-fluid">
          <div class="container">
            <div class="card card-custom">
                ...
                <div class="card-title"><h3 class="card-label">Book Categories</h3></div>
                  ...
                  <tbody> 
                      <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="odd gradeX">
                              ...
                              <td class="urdu text-left" > <?php echo e($item->title); ?></td>
                              <td class="text-center">
                                <a href="<?php echo e(route('admin.categories.edit', $item->id)); ?>" class="btn btn-sm btn-clean btn-icon" title="Edit"><i class="text-success la la-edit"></i></a>
                                      ...
                                      <div class="modal-dialog modal-dialog-centered " role="document">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-footer">
                                            ...
                                            <a href="<?php echo e(route('admin.categories.delete', $item->id)); ?>"  class="btn btn-primary">Delete</a>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
...
<?php echo $__env->make('admin.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mukalama/public_html/resources/views/admin/categories/index.blade.php ENDPATH**/ ?>