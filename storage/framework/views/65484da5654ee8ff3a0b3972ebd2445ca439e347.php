...
<?php $__env->startSection('title','Asnaf'); ?>
    ...
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
      <div class="d-flex align-items-center flex-wrap mr-2">
        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
          ...
          <li class="breadcrumb-item active"><a href="<?php echo e(route('admin.blogs.index')); ?>" class="text-muted">Asnaf</a>
          </li>
        </ul>
      </div>
      <div class="d-flex align-items-center">
          <a href="<?php echo e(route('admin.blogs.create')); ?>" class="update_btn btn btn-primary"> Add New </a>
          </div>
        </div>
      </div>
          ...
          <div class="container">
            <div class="card card-custom">
                <div class="card-header flex-wrap py-5">
                    <div class="card-title"><h3 class="card-label">Asnaf</h3></div>
                  ...
                  <tbody> 
                      <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="odd gradeX">
                            ...
                            <td class="text-left" ><img style="width: 50px" src="<?php echo e(asset($item->thumbnail)); ?>"  /> </td>
                            <td class="text-left urdu" > <?php echo e($item->title); ?></td>
                            <td class="text-left" > <?php echo e($item->date->format('d-m-Y')); ?></td>
                            <td class="text-center">
                                <a href="<?php echo e(route('admin.blogs.edit', $item->id)); ?>" class="btn btn-sm btn-clean btn-icon" title="Edit">
                                      ...
                                      <div class="modal-dialog modal-dialog-centered " role="document">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-footer">
                                            ...
                                            <a href="<?php echo e(route('admin.blogs.delete', $item->id)); ?>"  class="btn btn-primary">Delete</a>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mukalama/public_html/resources/views/admin/posts/index.blade.php ENDPATH**/ ?>