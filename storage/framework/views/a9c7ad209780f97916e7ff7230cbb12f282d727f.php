                   ...
                   <div class="align-self-center col-md-8">
                       <div class=" text-right ">
                          <form method="get" action="<?php echo e(route('cart.qty')); ?>" >
                              ...
                              <!--<p style="font-weight:bold; color:red;font-size: 32px;">Rs <?php echo e($item->price); ?></p>-->
                              <p style="color:black;font-size: 25px;"><?php echo e($item->category->title); ?> </p>
                              <?php if($item->price > 0): ?>
 ...
 <section style="padding: 8px 0;background-color: #EEEEEE;" >
        ...
        <div class="container" >
              ...
              <div class="py-5 text-center" >
                  <a href="<?php echo e(route('books')); ?>" style="background:#06194F" class="custom-btn-1 px-3 py-1 btn btn-primary" >مزید  بک  </a>
              </div>
        </div>
</section>
    ...
    <script>
      ...
      $(document).ready(function(){
          ...
          $('#book2').owlCarousel({
            ...
            const url = '<?php echo e(asset($item->pdf)); ?>';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mukalama/public_html/mukalma/resources/views/book.blade.php ENDPATH**/ ?>