          ...
          <div class="container">
            <div class="row">
              <div class="col-md-12 white-text text-center py-3">
                ...
                <h1 class="mb-0 pt-md-5 pt-5 text-white font-weight-bold wow fadeInDown" data-wow-delay="0.3s">{{Auth::user()->name}}</h1>
              </div>
            </div>
          </div>
        </div>
                            ...
                            <div class="col-lg-12 col-md-12">
                                <ul class="nav nav-pills pills-font mb-3 pl-lg-3 justify-content-center" id="pills-tab" role="tablist">
                                    <li class="nav-item pl-0 pr-lg-5 pr-md-3 pr-sm-4">
                                      <a class="nav-link " id="pills-desc-tab" data-toggle="pill" href="#pills-desc" role="tab" aria-controls="pills-desc" aria-selected="true">Poetry</a>
                                    </li>
                                    <li class="nav-item pl-lg-3 pr-lg-5 pr-md-3 pr-sm-4">
                                      <a class="nav-link active " id="pills-map-tab" data-toggle="pill" href="#pills-map" role="tab" aria-controls="pills-map" aria-selected="false">Books</a>
                                    </li>
                                    <li class="nav-item pl-lg-3 pr-lg-5 pr-md-3 pr-sm-4">
                                                        ...
                                                        <table class="table ">
                                                          ...
                                                          <tbody>
                                                             @foreach($orders as $key => $item)
                                                                    <?php $products =  unserialize($item->items); 
                                                                    ...
                                                                    @foreach($products as $product)
                                                                        <tr>
                                                                          ...
                                                                          <td> 
                                                                             @if($product['type'] == 'hard' ) 
                                                                               <a style="background:#138FCF" href="{{route('item',$product['slug'])}}" class="btn btn-primary">View</a>
                                                                             @else
                                                                              @if(Con::item($product['id']))
                                                                               <a style="background:#138FCF" target="_blank" href="{{asset(Con::item($product['id'])->pdf)}}" class="btn btn-primary">Download</a>
                                                                               @endif
                                                                             @endif
