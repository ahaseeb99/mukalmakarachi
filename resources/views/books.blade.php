            ...
            <div class="row">
                                ...
                                <a href="{{route('author',$author->slug)}}">
                                    <div class="row">
                                        <div class="col-10 text-right">
                                                <h1 style="font-size: 23px;color: black;" class="m-0">{{$author->title}} </h1>
                                        </div>
                                        <div class="col-2 align-self-center p-0">
                                                <img class="d-block" style="width: 40px;border-radius: 11px;" src="{{asset($author->thumbnail)}}">
                                        </div>
                                    </div>
                                </a>
                            </div>  
                ...
                <div class="col-md-9">
                        <div class="container-fluid">
                            <div class="row">
                               @foreach(Con::categories() as $items)
                               <div class="col-md-3">
                                    <div class="con shadow p-3 mb-5  ">
                                         <a href="{{route('item.category',$items->slug)}}"> <h1>{{$items->title}}</h1></a>
                                    </div>          
                                </div>  
                                @endforeach
                        </div>
