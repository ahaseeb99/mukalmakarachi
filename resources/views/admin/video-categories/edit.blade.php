        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-xl-7 my-2">
                <form enctype="multipart/form-data" method="post" action="{{route('admin.video-categories.update',$module->id)}}"  class="form-horizontal">
                   @csrf
                     <div class="form-body">
                        ...
                        <div class="form-group row">
                          <div class="col-12">
                             <label style="font-size:16px" class="col-form-label ext-lg-right text-left">Title (English)</label>
