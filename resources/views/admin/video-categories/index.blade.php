    ...
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
          <div class="d-flex align-items-center flex-wrap mr-2">
            <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
              ...
              <li class="breadcrumb-item active"><a href="{{route('admin.video-categories.index')}}" class="text-muted">Video Category</a></li>
            </ul>
          </div>
          ...
          <div class="container">
            <div class="card card-custom">
                <div class="card-header flex-wrap py-5">
                    <div class="card-title"><h3 class="card-label">Video Category</h3></div>
                      ...
                      @foreach ($modules as $key => $item)
                        <tr class="odd gradeX">
                              ...
                              <td class="text-center">
                                <a href="{{route('admin.video-categories.edit', $item->id)}}" class="btn btn-sm btn-clean btn-icon" title="Edit"><i class="text-success la la-edit"></i></a>
                                      ...
                                      <div class="modal-dialog modal-dialog-centered " role="document">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-footer">
                                            ...
                                            <a href="{{route('admin.video-categories.delete', $item->id)}}"  class="btn btn-primary">Delete</a>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
