...
@section('title','Asnaf Categories')
    ...
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
      <div class="d-flex align-items-center flex-wrap mr-2">
        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
          ...
          <li class="breadcrumb-item active"><a href="{{route('admin.blog-categories.index')}}" class="text-muted">Asnaf Categories</a></li>
        </ul>
      </div>
      <div class="d-flex align-items-center">
        <a href="{{route('admin.blog-categories.create')}}" class="update_btn btn btn-primary"> Add New </a>
          </div>
        </div>
      </div>
          ...
          <div class="container">
            <div class="card card-custom">
                <div class="card-header flex-wrap py-5">
                  <div class="card-title"><h3 class="card-label">Asnaf Categories</h3></div>
                ...
                <table class="table table-hover table-checkable" id="my_datatable" style="margin-top: 13px !important">
                  <thead>
                      <tr>
                        ...
                        <th style="font-size:16px" > Title (Urdu)</th>
                        <th style="font-size:16px" > Title (English)</th>
                  ...
                  <tbody> 
                      @foreach ($modules as $key => $item)
                        <tr class="odd gradeX">
                              ...
                              <td class="urdu text-left" > {{$item->title}}</td>
                              <td class="text-left" > {{$item->english}}</td>
                              <td class="text-center">
                                <a href="{{route('admin.blog-categories.edit', $item->id)}}" class="btn btn-sm btn-clean btn-icon" title="Edit">
                                      ...
                                      <div class="modal-dialog modal-dialog-centered " role="document">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-footer">
                                            ...
                                            <a href="{{route('admin.blog-categories.delete', $item->id)}}"  class="btn btn-primary">Delete</a>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
