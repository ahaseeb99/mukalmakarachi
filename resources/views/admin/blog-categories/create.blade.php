                ...
                <div class="col-6">
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                      ...
                      <li class="breadcrumb-item active">
                        <a href="{{route('admin.blog-categories.index')}}" class="text-muted">Asnaf Categories</a>
                      </li>
                    </ul>
                </div>
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-xl-7 my-2">
                    <form enctype="multipart/form-data" method="post" action="{{route('admin.blog-categories.store')}}"  class="form-horizontal">
                       @csrf
                      <div class="form-body">
