          ...
          <div class="container">
            <div class="card card-custom">
                 <div class="card-header flex-wrap py-5">
                    <div class="card-title"><h3 class="card-label">Videos</h3></div>
                      ...
                      @foreach ($modules as $key => $item)
                        <tr class="odd gradeX">
                              ...
                              <td class="text-center">
                                <a href="{{route('admin.videos.edit', $item->id)}}" class="btn btn-sm btn-clean btn-icon" title="Edit"><i class="text-success la la-edit"></i></a>
                                      ...
                                      <div class="modal-dialog modal-dialog-centered " role="document">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-footer">
                                            ...
                                            <a href="{{route('admin.videos.delete', $item->id)}}"  class="btn btn-primary">Delete</a>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
