            ...
            <div class="card-body">
              <div class="row">
                <div class="col-xl-12 my-2">
                    <form enctype="multipart/form-data" method="post" action="{{route('admin.videos.store')}}"  class="form-horizontal">
                       @csrf
                      <div class="form-body">
                        <div class="form-group row">
                          ...
                          <input required  name="video"   class="form-control form-control-lg" type="text" >
                          </div>
