        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-xl-7 my-2">
                <form enctype="multipart/form-data" method="post" action="{{route('admin.categories.update',$module->id)}}"  class="form-horizontal">
                   @csrf
                     <div class="form-body">
                        ...
                        <div class="form-group row">
                          <div class="col-12">
                            ...
                            <input  name="english" value="{{$module->english}}"  class="slug form-control form-control-lg" type="text" >
