                  ...
                  <tbody> 
                      @foreach ($modules as $key => $item)
                        <tr class="odd gradeX">
                              ...
                              <td class="center" > <img width="50px" height="50px" src="{{asset($item->thumbnail)}}" /> </td>
                              <td class="urdu center" > {{$item->title}} </td>
                              <td class="text-center">
                                <a href="{{route('admin.authors.edit', $item->id)}}" class="btn btn-sm btn-clean btn-icon" title="Edit"><i class="text-success la la-edit"></i></a>
                                      ...
                                      <div class="modal-dialog modal-dialog-centered " role="document">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-footer">
                                            ...
                                            <a href="{{route('admin.authors.delete', $item->id)}}"  class="btn btn-primary">Delete</a>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
