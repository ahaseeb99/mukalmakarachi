      ...
      <div class="card card-custom">
        <div class="card-body">
          <div class="row">
            ...
            <form enctype="multipart/form-data" method="post" action="{{route('admin.authors.update',$module->id)}}"  class="form-horizontal">
                @csrf
                      <div class="form-body">
                        ...
                        <div class="form-group row">
                            <div class="col-12">
                              ...
                              <textarea name="des" class="form-control" >{{$module->des}}</textarea>
                              @if($errors->has('des'))
                        ...
                        <div class="form-group row">
                          <div class="col-lg-12 ">
                              ...
                              <div class="input-group">
                                ...
                                <img class=" mt-3 d-block"  width="150px" src="{{asset($module->thumbnail)}}" >
                          </div>
                      </div> 
