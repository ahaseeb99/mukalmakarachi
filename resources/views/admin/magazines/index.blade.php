                  ...
                  <tbody>
                    @foreach ($modules as $key => $item)             
                        <tr class="odd gradeX">
                              ...
                              <td class="3 urdu text-left"> {{$item->title}}</td>
                              ...
                              <td class="16 text-center">
                                <a href="{{route('admin.magazines.edit', $item->id)}}" class="btn btn-sm btn-clean btn-icon" title="Edit">
                                      ...
                                      <div class="modal-dialog modal-dialog-centered " role="document">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-footer">
                                            ...
                                            <a href="{{route('admin.magazines.delete', $item->id)}}"  class="btn btn-primary">Delete</a>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
