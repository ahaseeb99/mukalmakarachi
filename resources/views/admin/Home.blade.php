		...
		<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
							...
							<div  class="card card-custom bg-danger  card-stretch gutter-b">
								...
								<div class="card-body">
									...
									<div class="text-inverse-danger font-weight-bolder font-size-h5  mt-5">
										Total Products ({{count(Con::items())}})</div>
								</div>
								<!--end::Body-->
							</div>
							<!--end::Stats Widget 13-->
						...
						<div class="col-md-2 col-lg-3">
							...
							<div  class="card card-custom bg-primary  card-stretch gutter-b">
								...
								<div class="card-body">
									...
									<div class="text-inverse-primary font-weight-bolder font-size-h5 mb-2 mt-5">Total Orders ({{count(Con::orders())}})</div>
								</div>
								<!--end::Body-->
							</div>
							<!--end::Stats Widget 14-->
							...
							<div  class="card card-custom bg-info  card-stretch gutter-b">
								...
								<div class="card-body">
									...
									<div class="text-inverse-success font-weight-bolder font-size-h5 mb-2 mt-5">Total Users 
										({{count(Con::getUsersByRoleName(["Customer"]))}})</div>
								</div>
								<!--end::Body-->
							</div>
							<!--end::Stats Widget 15-->
						...
						<div class="col-md-2 col-lg-3">
							...
							<div  class="card card-custom bg-success  card-stretch gutter-b">
								...
								<div class="card-body">
									...
									<div class="text-inverse-success font-weight-bolder font-size-h5 mb-2 mt-5">Total Blogs ({{count(Con::blogs())}})</div>
								</div>
								<!--end::Body-->
							</div>
							<!--end::Stats Widget 15-->
			...
			<div class="col-md-6">
					...
					<div class="card-body pt-1">
						<div class="tab-content mt-5" id="myTabLIist18">
							<div class="tab-pane fade " id="kt_tab_pane_1_1" role="tabpanel" aria-labelledby="kt_tab_pane_1_1">
								<div class="form">
									@foreach (Con::orders()->where('status','completed') as $item)
									<?php 
												...
												<th class="pl-0 py-5">
													<div class="symbol symbol-50 symbol-light mr-2">
														<span class="symbol-label">
															<img src="{{asset($item->user->image)}}" class="h-50 align-self-center" alt="">
														</span>
													</div>
												</th>
												<td class="py-6 pl-0">
													<a href="#" class="text-dark font-weight-bolder text-hover-primary mb-1 font-size-lg">{{$item->user->name}}</a>
													<span class="text-muted font-weight-bold d-block">Products {{count($products)}}</span>
												</td>
												<td class="text-right">
													<span class="text-muted font-weight-bold">{{$item->date->format("d-m-Y")}}</span>
												</td>

											    <td class="text-right pr-0">
											<a href="{{route("admin.orders.edit",$item->id)}}" class="btn btn-icon btn-light btn-sm">
				...
				<div class="tab-pane fade active show" id="kt_tab_pane_2_2" role="tabpanel" aria-labelledby="kt_tab_pane_2_2">
					<div class="form">
						@foreach (Con::orders()->where('status','pending') as $item)
						<?php 
							$products = unserialize($item->items);
						?>
						<div class="table-responsive">
							...
							<tr>
								...
								<td class="text-right pr-0">
											<a href="{{route("admin.orders.status",["id" => $item->id,"status" => "completed"])}}" class="btn btn-icon btn-light btn-sm">
												<span class="svg-icon svg-icon-md svg-icon-success">
												<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
						...
						<div class="col-md-6">
								...
								<div class="card-body pt-1">
									<div class="tab-content mt-5" id="myTabLIist18">
										<div class="tab-pane fade " id="kt_tab_pane_1_14" role="tabpanel" aria-labelledby="kt_tab_pane_1_14">
											<div class="form">
												@foreach(Con::reviews()->where('status',1) as $item)
												<?php 
												...
												<div class="table-responsive">
													<table class="table table-borderless table-vertical-center">
														...
														<tr>
															...
															<td class="py-6 pl-0">
																<a href="#" class="text-dark font-weight-bolder text-hover-primary mb-1 font-size-lg">{{$item->user->name}}</a>
																<span class="text-muted font-weight-bold d-block">{{$item->body}}</span>
															</td>
															<td class="text-right">
																<span class="text-muted font-weight-bold">{{$item->created_at->format("d-m-Y")}}</span>
															</td>
			
															<td class="text-right pr-0">
														<a href="{{route("admin.blogs.edit",$item->blog_id)}}" class="btn btn-icon btn-light btn-sm">
															<span class="svg-icon svg-icon-md svg-icon-success">
																<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																	<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																		<polygon points="0 0 24 0 24 24 0 24"></polygon>
							...
							<div class="tab-pane fade active show" id="kt_tab_pane_2_23" role="tabpanel" aria-labelledby="kt_tab_pane_2_23">
								<div class="form">
									@foreach (Con::reviews()->where('status',0) as $item)
									...
									<div class="table-responsive">
										...
										<tr>
											...
											<td class="text-right pr-0">
														<a href="{{route("admin.reviews.status",["id" => $item->id,"status" => 1])}}" class="btn btn-icon btn-light btn-sm">
															<span class="svg-icon svg-icon-md svg-icon-success">
															<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
															<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
															<polygon points="0 0 24 0 24 24 0 24"/>
