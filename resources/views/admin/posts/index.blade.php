    ...
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
      <div class="d-flex align-items-center flex-wrap mr-2">
        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
          ...
          <li class="breadcrumb-item active"><a href="{{route('admin.blogs.index')}}" class="text-muted">Asnaf</a>
          </li>
        </ul>
      </div>
                  ...
                  <tbody> 
                      @foreach ($modules as $key => $item)
                        <tr class="odd gradeX">
                            ...
                            <td class="text-left" > {{$item->date->format('d-m-Y')}}</td>
                            <td class="text-center">
                                <a href="{{route('admin.blogs.edit', $item->id)}}" class="btn btn-sm btn-clean btn-icon" title="Edit">
                                      ...
                                      <div class="modal-dialog modal-dialog-centered " role="document">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-footer">
                                            ...
                                            <a href="{{route('admin.blogs.delete', $item->id)}}"  class="btn btn-primary">Delete</a>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
