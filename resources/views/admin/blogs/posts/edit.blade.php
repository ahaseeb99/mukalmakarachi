            ...
            <div class="row">
              <div class="col-6">
                  <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                      ...
                      <li class="breadcrumb-item ">
                        <a href="{{route('admin.posts.index',$post->module->plural)}}" class="text-muted">{{$post->module->plural}}</a>
                      </li>
                ...
                <div class="dropdown dropdown-inline"  data-placement="left" >
                  ...
                  <div class="dropdown-menu p-0 m-0 dropdown-menu-md dropdown-menu-right py-3" style="">
                    ...
                    <ul class="navi navi-hover py-5">
                        <li class="navi-item">
                          <a  href="{{route('admin.posts.create',$post->module->plural)}}" class="navi-link">
               ...
               <div class="col-md-8" >
                            ...
                            <div class="card-body">
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-lg-12">
                                  ...
                                  <input name="title" value="{{$post->title}}" class="title form-control" type="text" required >
                                   @if($errors->has('title'))
                                ...
                                <div class="col-lg-12">
                                  ...
                                  <input name="slug" value="{{$post->slug}}" class="slug form-control" type="text" required >
                                   @if($errors->has('slug'))
                                ...
                                @php 
                                  $oldval = unserialize($post->attributes);
                                  
                                  $attributes = unserialize($post->module->fields);   
                                @endphp
                                ...
                                @if(is_array($attributes))
                                 ...
                                 @endphp
                                    <div class="col-lg-12">
                                      ...
                                      <input name="items[{{$field}}]" value="@if(isset($value)){{$value}}@endif" class="form-control" type="text">
                                    </div>
                                 @endforeach
                                @endif
                            </div>
                        ...
                        <div class="card card-custom gutter-b">
                                ...
                                <div class="card-body">
                                    ...
                                    <textarea class="form-control" name="des" id="editor1">{{$post->des}}</textarea>
                                ...
                                <div class="card-body">
                                    <label class="font-size-h3 font-weight-bolder text-dark mb-7">Gallery</label>
                                     <div class="form-group">
                                      ...
                                      <div class="input-group">
                                        ...
                                        <input id="thumbnail1"  class="form-control" type="text" name="gallery"  value="{{$post->gallery}}" />
                                      </div>
                                </div>
                                  @php  $gallery = explode(',',$post->gallery);  
                                  ...
                                  @if(is_array($gallery))
                                    @foreach($gallery as $gal)
                                      <img width="100px" height="100px" src="{{asset($gal)}}"  />
                                    @endforeach
                                  @endif
                ...
                <div class="card card-custom gutter-b">
        		   <div class="card-body">
				    ...
				    <select class="form-control" name="status" autocomplete="off" >
						 <option @if($post->status == "approved") {{"selected"}} @endif value="approved" >Approve</option>
                     ...
                     <div class="card-body">
                          ...
                          <div class="form-group row">
                            <div class="col-lg-12">
                              ...
                              <img class="pt-3" src="{{asset($post->thumbnail)}}" width="100%" height="100px"  />
                              @endif
                            </div>
                            </div>
                        </div>
