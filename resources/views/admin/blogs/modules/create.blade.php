...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <form enctype="multipart/form-data" method="post" action="{{route('admin.modules.store')}}">
      @csrf
                            ...
                            <div class="card-body">
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-lg-12">
                                  ...
                                  <input name="plural" value="{{old('plural')}}" class="form-control" type="text" required >
                               ...
                               <div class="col-lg-12">
                                  ...
                                  <input name="icon" value="{{old('icon')}}"   class=" form-control" type="text" required >
                                   @if($errors->has('icon'))
