          ...
          <div class="container">
            <div class="card card-custom">
              <div class="card-header flex-wrap py-5">
                <div class="card-title"><h3 class="card-label">All Modules</h3></div>
                  ...
                  <tbody>
                   @foreach ($modules as $key => $item)
                        <tr class="odd gradeX">
                              ...
                              <td class="4 text-center" ><i class="menu-icon  {{$item->icon}}"></i></td>
                              <td class="2 text-center">{{$item->title}}</td>
                              <td class="3 text-center">{{$item->plural}}</td>
                              <td class="9 text-center">{{$item->created_at->format('d-m-Y')}}</td>
                              <td class="16 text-center">
                                <a href="{{route('admin.modules.edit', $item->id)}}" class="btn btn-sm btn-clean btn-icon" title="Edit"><i class="text-success la la-edit"></i></a>
                                <a href="{{route('admin.modules.delete', $item->id)}}" class="btn btn-sm btn-clean btn-icon" title="Delete"><i class="text-danger la la-trash"></i></a>
                              </td>
                        </tr>
                      @endforeach
                  </tbody>
