...
@section('css')
	...
	<link rel="stylesheet" type="text/css" href="{{asset('front/js/export/style.css')}}">
	<link rel="stylesheet" type="text/css" href="{{asset('front/js/export/ipages.min.css')}}">
...
<script type="text/javascript" src="{{asset('front/js/export/pdf.min.js')}}"></script>
<script type="text/javascript" src="{{asset('front/js/export/jquery.ipages.min.js')}}"></script>
